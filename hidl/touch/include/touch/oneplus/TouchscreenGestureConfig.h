...
const std::map<int32_t, TouchscreenGesture::GestureInfo> kGestureInfoMap = {
    ...
    {1, {67, "Up arrow", "/proc/touchpanel/up_arrow_enable"}},
    ...
    {9, {255, "Single Tap", "/proc/touchpanel/single_tap_enable"}},
    {10, {66, "One finger up swipe", "/proc/touchpanel/up_swipe_enable"}},
    {11, {64, "One finger down swipe", "/proc/touchpanel/down_swipe_enable"}},
    {12, {63, "One finger left swipe", "/proc/touchpanel/left_swipe_enable"}},
    {13, {65, "One finger right swipe", "/proc/touchpanel/right_swipe_enable"}},
};
